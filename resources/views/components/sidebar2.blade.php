    ...
    >
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1 flex items-center">
                ...
                <h1 class="font-bold text-gray-200 text-[15px] ml-3">İp Envanteri</h1>
                <i
        ...
        >
            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">
                <a href="/devices" class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">Bütün Cihazlar</a>
