        ...
        <div class="flex-auto p-4" >
            ...
            <div class="bg-white rounded-xl mt-8  overflow-x-auto space-x-4 space-y-4">
                ...
                <table class="min-w-full" >
                    <thead >
                    <tr>
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Bina</th>
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Birim</th>
                    ...
                    @foreach($locations as $location)
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">{{ $location->building }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">{{ $location->unit }}</div>
                            </td>
                            @canany(['update location','delete location'])
